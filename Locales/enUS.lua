...
L["Boss Debuffs only trigger"] = true
L["Both"] = true
L["Bottom"] = true
L["Bottom Edge"] = true
L["Bottom Left"] = true
...
L["Open edit mode to preview the Blizzard dispel overlay."] = true
...
L["Sort Order"] = true
L["Sort party members by role (or keep Blizzard party/raid index order).\n\nWhen sorting by role the order is: Self Position > Role > Class > Name"] = true
...
L["Use Party/Raid Index Order (ignore role)"] = true
...
L["in Hybrid or Blizzard mode."] = true
